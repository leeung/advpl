...
Autor		J�lio Wittwer
Data 		01/2020
Descri��o 	Programa de demonstra��o e uso da API de Mensagens WhatsApp NETIZAP

Funcionalidades da API encapsuladas pela classe NETIZAP()

====================================================================== */

// --- Chaves de demonstra��o da API  ----
...
@ 05,300 BUTTON oBtn PROMPT "Chaves de Demonstra��o" SIZE 120,12 ;
...
@ 0,0 FOLDER oFldStat PROMPTS 	"Retorno da Requisi��o" ;
...
@ 40,10 SAY "Reference (Refer�ncia - opcional) " SIZE 180,12 OF oAba1 PIXEL 
...
@ 155,10 SAY "Para enviar para um grupo ou lista de broadcast, utilize em 'destiny' o c�digo de um grupo ou lista, "+;
...
@ 40,10 SAY "Reference (Refer�ncia - opcional) " SIZE 180,12 OF oAba2 PIXEL 
...
@ 190,10 SAY "Uma quest�o aguarda uma resposta, onde as respostas que podem ser marcadas como v�lidas "+;
			 "deve ser especificadas entre colchetes e separadas por ponto e v�rgula. A resposta da pergunta "+;
			 "pode ser consultada pelo protocolo gerado no envio, usando o m�todo QuestionSearch()." SIZE 200,120 OF oAba2 PIXEL 
...
@ 40,10 SAY "Reference (Refer�ncia - opcional) " SIZE 180,12 OF oAba3 PIXEL 
...
@ 250,10 SAY "Um arquivo pode ser escolhido e enviado junto da mensagem. O Conteudo do arquivo deve ser enviado  "+;
			 "codificado em BASE64. O nome do arquivo que enviamos � o nome que ser� usado para identificar o arquivo "+;
...
@ 10,10 BUTTON oBtn4 PROMPT "Pesquisar Registro de Requisi��es" ACTION (	oNetIZap:Reset(),;
												oNetIZap:SetLine(cLine),;
												oNetIZap:SetAccessKey(cAccessKey),;
												oNetIZap:SetPort(nPort),;
												MsgRun("Pesquisando Registro de Requisi�oes ...","Aguarde",{||ReqStart(oNetIZap,oGetResponse)}) ) ;
												OF oAba9 PIXEL 


// Folder "Retorno da Requisi��o"
...
If oNetIZap:MessageSend()
	...
	// [{"errors": [{"code": "400.002", "type": "APIException", "message": "Erro na autentica+�+�o.", "link": "" }]}]
...
/* -----------------------------------------------------------
A��o de envio de uma mensagem com pergunta e respostas esperadas
----------------------------------------------------------- */
...
/* -----------------------------------------------------------
A��o de envio de uma mensagem com arquivo anexo
----------------------------------------------------------- */
